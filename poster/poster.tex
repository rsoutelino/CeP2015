...
\begin{figure}
\includegraphics[width=0.8\linewidth]{schematics.png}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{domains.png}
\caption{Figure caption}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{mean_flow.png}
\caption{Figure caption}
\end{figure}
...
Nunc tempus venenatis facilisis. \textbf{Curabitur suscipit} consequat eros non porttitor.

\begin{figure}
\includegraphics[width=0.5\linewidth]{taylor.png}
\caption{Figure caption}
\end{figure}
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=0.6\linewidth]{msllogo.jpg}
\end{tabular}
\end{center}
